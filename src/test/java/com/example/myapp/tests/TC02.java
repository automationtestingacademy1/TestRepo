...
public class TC02 extends BaseTest{
	...
	@Test(priority=1, dataProviderClass=TC02.class, dataProvider="TestData")
	public void testcase2(String tc, String UserId, String Password) throws Exception
	{
		ExtentTest report= extent.createTest("testcase2");
